...
import com.louay.conservatoire.service.ImageService;
...
public class ImageRESTController {
	 ...
	 @PostMapping(value = "/uplaodImageMus/{idMus}" )
	 public Image uploadMultiImages(@RequestParam("image")MultipartFile file,
			 @PathVariable("idMus") Long idMus) 
					 throws IOException {
		 return imageService.uplaodImageMus(file,idMus);
	 }
	 
	 @RequestMapping(value = "/getImagesMus/{idMus}" , method = RequestMethod.GET)
	 public List<Image> getImagesProd(@PathVariable("idMus") Long idMus) 
			 throws IOException {
		 return imageService.getImagesParMus(idMus);
	 }
